...
<Note>
Many of the type annotations shown below are technically redundant, since mypy can usually infer the type of a variable from its value. See the [type inference documentation](/type-system/type-inference) for more details.
</Note>
